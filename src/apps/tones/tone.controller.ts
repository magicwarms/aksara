...
export const getAllTone = async (
    req: Request<unknown, unknown, unknown, queryFindToneData>,
    res: Response
): Promise<Response> => {
...
export const storeOrUpdateTone = async (
    req: Request,
    res: Response,
    next: NextFunction
...
export const deleteTone = async (req: Request, res: Response, next: NextFunction): Promise<Response | undefined> => {
    try {
