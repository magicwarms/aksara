...
export const getAllFeature = async (
    req: Request<unknown, unknown, unknown, queryFindFeatureData>,
    res: Response
): Promise<Response> => {
...
export const storeOrUpdateFeature = async (
    req: Request,
    res: Response,
    next: NextFunction
...
export const deleteFeature = async (req: Request, res: Response, next: NextFunction): Promise<Response | undefined> => {
    try {
